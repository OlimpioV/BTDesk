...
function modalConfirm(msg,onOk){document.getElementById("modal-container").innerHTML='<div class="modal-overlay" style="align-items:center;" onclick="document.getElementById(\'modal-container\').innerHTML=\'\''><div class="modal-box" style="width:min(95vw,400px);padding:24px 28px;" onclick="event.stopPropagation()"><div style="font-size:15px;font-weight:600;color:var(--bt-navy);margin-bottom:18px;">'+msg+'</div><div style="display:flex;gap:8px;justify-content:flex-end;"><button class="btn" onclick="document.getElementById(\'modal-container\').innerHTML=\'\'" >Cancelar</button><button class="btn btn-danger" id="mc-ok-btn">Excluir</button></div></div></div>';document.getElementById("mc-ok-btn").onclick=function(){document.getElementById("modal-container").innerHTML="";onOk();};}
function modalInput(title,placeholder,onOk){document.getElementById("modal-container").innerHTML='<div class="modal-overlay" style="align-items:center;" onclick="document.getElementById(\'modal-container\').innerHTML=\'\''><div class="modal-box" style="width:min(95vw,400px);padding:24px 28px;" onclick="event.stopPropagation()"><div style="font-size:15px;font-weight:600;color:var(--bt-navy);margin-bottom:14px;">'+title+'</div><div class="field"><input id="modal-input-val" placeholder="'+placeholder+'"/></div><div style="display:flex;gap:8px;justify-content:flex-end;"><button class="btn" onclick="document.getElementById(\'modal-container\').innerHTML=\'\'" >Cancelar</button><button class="btn btn-primary" id="mi-ok-btn">Confirmar</button></div></div></div>';var inp=document.getElementById("modal-input-val");var okBtn=document.getElementById("mi-ok-btn");function doOk(){var v=(inp?inp.value:"").trim();if(!v){if(inp)inp.focus();return;}document.getElementById("modal-container").innerHTML="";onOk(v);}if(okBtn)okBtn.onclick=doOk;if(inp)inp.onkeydown=function(e){if(e.key==="Enter")doOk();if(e.key==="Escape")document.getElementById("modal-container").innerHTML="";};setTimeout(function(){if(inp)inp.focus();},50);}
