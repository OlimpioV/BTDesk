...
- Chave service_role (apenas para uso local pelo Codex, nunca colocar no código): disponível na variável de ambiente `SUPABASE_SERVICE_KEY`

### Como o Codex deve rodar SQLs no Supabase
