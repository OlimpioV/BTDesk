...
- reunioes(id, titulo, data, hora, status, observacoes, equipe_id, criado_por, criado_em, tipo, modelo_id, modelo_snapshot jsonb, campos_valores jsonb)
- reuniao_modelos(id, nome, cor, icone, slug, equipe_id, criado_por, criado_em, campos jsonb)
